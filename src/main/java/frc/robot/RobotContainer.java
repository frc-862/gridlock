...
public class RobotContainer extends LightningContainer {
    ...
    protected void configureAutonomousCommands() {
        ...
        // autoFactory.makeTrajectory("Path4StartACharge", Maps.getPath4StartAChargeMap(drivetrain, servoturn), new PathConstraints(AutonomousConstants.MAX_VELOCITY, AutonomousConstants.MAX_ACCELERATION));
        ...
        autoFactory.makeTrajectory("Path6StartCCharge", Maps.getPath6ChargeMapLift(drivetrain, servoturn, lift, collector), new PathConstraints(AutonomousConstants.MAX_VELOCITY, AutonomousConstants.MAX_ACCELERATION));
        ...
        // autoFactory.makeTrajectory("Path9StartBCharge", Maps.getPath9StartBChargeMap(drivetrain, servoturn), new PathConstraints(AutonomousConstants.MAX_VELOCITY, AutonomousConstants.MAX_ACCELERATION));
    }
