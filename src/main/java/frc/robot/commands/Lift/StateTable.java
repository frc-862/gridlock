...
public class StateTable {
    ...
    private static Map<LiftState, StateTransition> defaultTable = Map.of(
        LiftState.stowed, new StateTransition(ELEVATOR_STOWED_POS, Rotation2d.fromDegrees(ARM_STOWED_ANGLE), Rotation2d.fromDegrees(WRIST_STOWED_ANGLE), LiftPlan.armAndWristThenEle, LiftState.stowed, ELEVATOR_STOWED_TOLERANCE, ARM_STOWED_TOLERANCE, WRIST_STOWED_TOLERANCE),
        ...
        LiftState.midCubeScore, new StateTransition(ELEVATOR_MID_CUBE_POS, Rotation2d.fromDegrees(ARM_MID_CUBE_ANGLE), Rotation2d.fromDegrees(WRIST_MID_CUBE_ANGLE), MID_CUBE_PLAN, LiftState.midCubeScore, ELEVATOR_MID_CUBE_TOLERANCE, ARM_MID_CUBE_TOLERANCE, WRIST_MID_CUBE_TOLERANCE), 
        ...
        private static Map<LiftState, StateTransition> scoreTable;
        private static Map<LiftState, StateTransition> groundTable;

        static {
            scoreTable.putAll(defaultTable);
                scoreTable.replace(LiftState.stowed, new StateTransition(ELEVATOR_DEPLOYED_POS, Rotation2d.fromDegrees(-70), Rotation2d.fromDegrees(WRIST_STOWED_ANGLE), LiftPlan.eleAndWristThenArm, LiftState.stowedScore, ELEVATOR_STOWED_TOLERANCE, 15, 10));
                scoreTable.replace(LiftState.groundCube, new StateTransition(ELEVATOR_GROUND_CUBE_POS, Rotation2d.fromDegrees(ARM_GROUND_CUBE_ANGLE), Rotation2d.fromDegrees(112), GROUND_CUBE_PLAN, LiftState.scoreToCollect, ELEVATOR_GROUND_CUBE_TOLERANCE, ARM_GROUND_CUBE_TOLERANCE, 20)); 
                scoreTable.replace(LiftState.groundCone, new StateTransition(ELEVATOR_GROUND_CONE_POS, Rotation2d.fromDegrees(ARM_GROUND_CONE_ANGLE), Rotation2d.fromDegrees(112), GROUND_CONE_PLAN, LiftState.scoreToCollect, ELEVATOR_GROUND_CONE_TOLERANCE, ARM_GROUND_CONE_TOLERANCE, 20)); 

            groundTable.putAll(defaultTable);
                groundTable.replace(LiftState.stowed, new StateTransition(ELEVATOR_STOW_COLLECT_TRANSITION_POS, Rotation2d.fromDegrees(ARM_STOW_COLLECT_TRANSITION_ANGLE), Rotation2d.fromDegrees(WRIST_STOW_COLLECT_TRANSITION_ANGLE), LiftPlan.eleAndWristThenArm, LiftState.stowedCollect, ELEVATOR_STOW_COLLECT_TRANSITION_TOLERANCE, ARM_STOW_COLLECT_TRANSITION_TOLERANCE, WRIST_STOW_COLLECT_TRANSITION_TOLERANCE));
    ...
    private static Map<LiftState, Map<LiftState, StateTransition>> stateTable = Map.ofEntries(
            Map.entry(LiftState.stowed, Map.of(
                ...
                LiftState.midCubeScore,             new StateTransition(ELEVATOR_DEPLOYED_POS, Rotation2d.fromDegrees(-70), Rotation2d.fromDegrees(WRIST_STOWED_ANGLE), LiftPlan.eleArmWrist, LiftState.stowedScore, ELEVATOR_STOWED_TOLERANCE, 20, WRIST_STOWED_TOLERANCE),
                LiftState.midConeScore,             new StateTransition(ELEVATOR_DEPLOYED_POS, Rotation2d.fromDegrees(-70), Rotation2d.fromDegrees(WRIST_STOWED_ANGLE), LiftPlan.eleArmWrist, LiftState.stowedScore, ELEVATOR_STOWED_TOLERANCE, 20, WRIST_STOWED_TOLERANCE),
                LiftState.highCubeScore,            new StateTransition(ELEVATOR_DEPLOYED_POS, Rotation2d.fromDegrees(-70), Rotation2d.fromDegrees(WRIST_STOWED_ANGLE), LiftPlan.eleArmWrist, LiftState.stowedScore, ELEVATOR_STOWED_TOLERANCE, 20, WRIST_STOWED_TOLERANCE),
                LiftState.highConeScore,            new StateTransition(ELEVATOR_DEPLOYED_POS, Rotation2d.fromDegrees(-70), Rotation2d.fromDegrees(WRIST_STOWED_ANGLE), LiftPlan.eleArmWrist, LiftState.stowedScore, ELEVATOR_STOWED_TOLERANCE, 20, WRIST_STOWED_TOLERANCE),                
                LiftState.doubleSubstationCollect,  new StateTransition(ELEVATOR_DEPLOYED_POS, Rotation2d.fromDegrees(-70), Rotation2d.fromDegrees(WRIST_STOWED_ANGLE), LiftPlan.eleArmWrist, LiftState.stowedScore, ELEVATOR_STOWED_TOLERANCE, 20, WRIST_STOWED_TOLERANCE),
                LiftState.singleSubstationCollect,  new StateTransition(ELEVATOR_DEPLOYED_POS, Rotation2d.fromDegrees(-70), Rotation2d.fromDegrees(WRIST_STOWED_ANGLE), LiftPlan.eleArmWrist, LiftState.stowedScore, ELEVATOR_STOWED_TOLERANCE, 20, WRIST_STOWED_TOLERANCE))), 
            ...
            Map.entry(LiftState.stowedCollect, Map.of(
                LiftState.stowed, new StateTransition(ELEVATOR_STOWED_POS, Rotation2d.fromDegrees(ARM_STOWED_ANGLE), Rotation2d.fromDegrees(WRIST_STOWED_ANGLE), LiftPlan.armAndWristThenEle, LiftState.stowed, ELEVATOR_STOWED_TOLERANCE, ARM_STOWED_TOLERANCE, 10),
            ...
            Map.entry(LiftState.stowedScore, Map.of(
                ...
                LiftState.midCubeScore, new StateTransition(ELEVATOR_MID_CUBE_POS, Rotation2d.fromDegrees(ARM_MID_CUBE_ANGLE), Rotation2d.fromDegrees(WRIST_MID_CUBE_ANGLE), LiftPlan.armAndWristThenEle, LiftState.midCubeScore, ELEVATOR_MID_CUBE_TOLERANCE, 20, 20), 
