...
public class StateTable {
    ...
    private static Map<LiftState, StateTransition> nextStateTable = Map.of(LiftState.stowed,
            new StateTransition(LiftConstants.ELEVATOR_STOWED_POS, Rotation2d.fromDegrees(LiftConstants.ARM_STOWED_ANGLE), Rotation2d.fromDegrees(LiftConstants.WRIST_STOWED_ANGLE),
                    LiftPlan.elevatorLast, LiftState.stowed),
            LiftState.transition,
            new StateTransition(LiftConstants.ELEVATOR_TRANSITION_POS, Rotation2d.fromDegrees(LiftConstants.ARM_TRANSITION_ANGLE), Rotation2d.fromDegrees(LiftConstants.WRIST_TRANSITION_ANGLE),
                    LiftPlan.parallel, LiftState.transition),
            LiftState.ground, new StateTransition(0, Rotation2d.fromDegrees(-70.5), Rotation2d.fromDegrees(30.0), LiftPlan.wristPriority, LiftState.ground), LiftState.midCubeScore,
            new StateTransition(10, Rotation2d.fromDegrees(-45), Rotation2d.fromDegrees(0), LiftPlan.parallel, LiftState.midCubeScore), LiftState.midConeScore,
            ...
            new StateTransition(20, Rotation2d.fromDegrees(-45), Rotation2d.fromDegrees(0), LiftPlan.parallel, LiftState.highCubeScore), LiftState.highConeScore,
            ...
            new StateTransition(5, Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0), LiftPlan.parallel, LiftState.doubleSubstationCollect), LiftState.reverseSubstationCollect,
            new StateTransition(5, Rotation2d.fromDegrees(60), Rotation2d.fromDegrees(0), LiftPlan.parallel, LiftState.reverseSubstationCollect));
