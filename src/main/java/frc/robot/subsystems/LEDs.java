...
public class LEDs extends SubsystemBase {
  ...
  // Create LEDs
  private CANdle leds = new CANdle(ledPort, "Canivore");
  ...
  public void swirl() {
    ...
    for (int i = 0; i < swirlLength; i++){
        leds.setLEDs(255, 75, 0, 0, ((i + orangeSwirlPosition) % ledLength), 1);
    }
    for (int i = 0; i < swirlLength; i++){
        leds.setLEDs(0, 0, 255, 0, ((i + blueSwirlPosition) % ledLength), 1);
    }
