...
public class Drivetrain extends SubsystemBase {
    ...
    private void initializeShuffleboard() {
        periodicShuffleboard = new LightningShuffleboardPeriodic("Drivetrain", DrivetrainConstants.LOG_PERIOD, 
                ...
                new Pair<String, Object>("Front left target velocity", (DoubleSupplier) () -> states[0].speedMetersPerSecond), // TODO: cpare these to acutal speeds
                ...
                new Pair<String, Object>("Front left target velocity", (DoubleSupplier) () -> states[0].angle.getDegrees()),
                new Pair<String, Object>("Front right target velocity", (DoubleSupplier) () -> states[1].angle.getDegrees()),
                new Pair<String, Object>("Back left target velocity", (DoubleSupplier) () -> states[2].angle.getDegrees()),
                new Pair<String, Object>("Back right target velocity", (DoubleSupplier) () -> states[3].angle.getDegrees()),
                new Pair<String, Object>("Odometry Heading", (DoubleSupplier) () -> getHeading().getDegrees()), new Pair<String, Object>("odo X", (DoubleSupplier) () -> pose.getX()),
