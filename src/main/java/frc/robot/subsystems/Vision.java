...
public class Vision extends SubsystemBase {
    ...
    private void updateShuffleboard() {
        if (getHasVision()) {
            ...
            LightningShuffleboard.setDoubleArray("Vision", "Vision robot bot pose blue", new double[]{getRobotPoseBlue().getX(),getRobotPoseBlue().getY(), getRobotPoseBlue().getRotation().getDegrees()});
            LightningShuffleboard.setDoubleArray("Vision", "Vision robot bot pose red", new double[]{getRobotPoseRed().getX(),getRobotPoseRed().getY(), getRobotPoseRed().getRotation().getDegrees()});
